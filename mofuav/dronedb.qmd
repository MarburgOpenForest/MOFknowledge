...
```json
{
  "AppSettings": {
    ...
    "ExternalUrlOverride": "http://137.248.191.201:5000",
  ...
  "AllowedHosts": "*",
  "ConnectionStrings": {
    "IdentityConnection": "Server=db;Database=RegistryAuth;Uid=registry;Pwd=passwd02",
    "RegistryConnection": "Server=db;Database=RegistryData;Uid=registry;Pwd=passwd02",
    "HangfireConnection": "Server=db;Database=RegistryHangfire;Uid=registry;Pwd=passwd02;Allow User Variables=true"
  },
  "Serilog": {
    "LevelSwitches": {
...
export MYSQL_ROOT_PASSWORD="passwd01"
export MYSQL_PASSWORD="passwd02"
export REGISTRY_ADMIN_MAIL="creuden@gmail.com"
...
export EXTERNAL_URL="http://137.248l191.201:5000"
...
EXTERNAL_URL="http://137.248.191.201:5000"
...
```bash
http://137.248.191.201:5000/swagger/index.html
```
